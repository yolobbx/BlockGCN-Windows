...
<table><tr><td>Multi-relational Modeling Methods</td><td>Complexity</td><td>Parameters</td></tr><tr><td>Vanilla GC (Baseline)</td><td><eq>\mathcal{O}(|\mathcal{V}|d^{2})</eq></td><td><eq>d^{2} + |\mathcal{V}|^{2}</eq></td></tr><tr><td>Ensemble of GCs</td><td><eq>\mathcal{O}(K|\mathcal{V}|d^{2})</eq></td><td><eq>Kd^{2} + K|\mathcal{V}|^{2}</eq></td></tr><tr><td>Ensemble of Adjacency Matrices</td><td><eq>\mathcal{O}(|\mathcal{V}|d^{2})</eq></td><td><eq>d^{2} + K|\mathcal{V}|^{2}</eq></td></tr><tr><td>Proposed BlockGC</td><td><eq>\mathcal{O}(\frac{|\mathcal{V}|d^{2}}{K})</eq></td><td><eq>\frac{d^{2}}{K} + K|\mathcal{V}|^{2}</eq></td></tr></table>
