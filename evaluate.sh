...
python main.py --weights work_dir/ntu60/csub/140_epochs/runs-140-87640.pt --phase test --save-score True --config config/nturgbd-cross-subject/default.yaml --model model.BlockGCN.Model --work-dir  work_dir/ntu60/csub/test --device 0
